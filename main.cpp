...
int WINAPI WinMain(_In_ HINSTANCE, _In_opt_ HINSTANCE, _In_ LPSTR, _In_ int) {
	...
	BillboardImage text2(TextDrawer::CreateStringTexture("ゲーミング板ポリ", "ＭＳ Ｐ明朝", 32), {0.25f, 0.25f});
	...
	BillboardImage text3(TextDrawer::CreateStringTexture("複数のテクスチャを読み込んで描画できます", "ＭＳ Ｐ明朝", 32), { 0.25f, 0.25f });
